...
def part_one(inputs)                                        # RETURN COUNT OF VALID STRINGS WHERE # OF CHAR IN STRING IS IN RANGE
    arr = inputs.split("\n").map {|spec| spec}
...
def part_two(inputs)                            # RETURN COUNT OF VALID STRINGS WHERE INDEXED CHAR IS EITHER RANGE[0] OR RANGE[1] BUT NOT BOTH
    arr = inputs.split("\n").map {|spec| spec}  # ALSO, THERE IS NO 0 INDEX
    valid_count = 0
...
# p part_one(inputs)          # 439
# p part_two(inputs)          # 584
